...
"https://raw.githubusercontent.com/hacamer/AdRule/main/url-filter.txt" #url过滤器 by Hacamer
...
dns=(
  ...
  "https://raw.githubusercontent.com/crazy-max/WindowsSpyBlocker/master/data/hosts/spy.txt"  "https://raw.githubusercontent.com/hacamer/AdRule/main/dns.txt"
  "https://raw.githubusercontent.com/banbendalao/ADgk/master/ADgk.txt"
  "http://msedl.360safe.com/360mse/bcdbgimoikiapdjnifgghhgcfoclpchk/100129/bcdbgimoikiapdjnifgghhgcfoclpchk.txt"
)
...
curl http://msedl.360safe.com/360mse/bcdbgimoikiapdjnifgghhgcfoclpchk/100129/bcdbgimoikiapdjnifgghhgcfoclpchk.txt|grep -v "@" > easylist360.txt
# 添加空格
file="$(ls|sort -u)"
for i in $file; do
  echo -e '\n\n\n' >> $i &
